...
<title>AIUM - Adbanced Image Upload & Manager v.1.1</title>
      ...
      <div id="content_border">
        ...
        <div id="content_bg">
          ...
          <div id="content_seperator">
            ...
            <div id="right_column">
              <?php
echo "<p><? echo $lang[thx];?>, <b>$_POST[name]</b>, <? echo $lang[fmessage];?>!</p>";
echo "<p>Your email adress: <b>$_POST[email]</b></p>";
echo "<p><? echo $lang[ymessage];?>:<br>";
echo "<b>$_POST[mesaj] </b></p>";
$msg = "<? echo $lang[name];?>:    $_POST[name]\n";
$msg .= "<? echo $lang[email];?>:  $_POST[email]\n";
$msg .= "<? echo $lang[message];?>:  $_POST[mesaj]\n";
$recipient = "<?=$email_ad?>";
$subject = "<? echo $lang[cmessage];?>";
$mailheaders = "<? echo $lang[cfrom];?> <?=$email_ad?> \n";
$mailheaders .= "<? echo $lang[femail];?>: $_POST[email]";
